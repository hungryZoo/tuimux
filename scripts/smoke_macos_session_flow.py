...
def run_window_flow(client: PtyClient, timeout: float) -> None:
    ...
    wait_or_fail(client, "2: shell-2", timeout, "second window row")
    ...
    wait_or_fail(client, "1: shell", timeout, "remaining first window row")
...
def main() -> int:
    ...
    try:
        ...
        try:
            ...
            wait_or_fail(second, "1: shell", args.timeout, "reattached window list")
