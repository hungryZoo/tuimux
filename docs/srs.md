...
- 붙여넣기 직후 child shell이 paste highlight를 그려둔 경우 다음 일반 terminal left click에서 하이라이트가 해제되어야 한다.
...
- **FR-IN-21 [P0]** paste 성공 후 child mouse protocol이 꺼진 terminal body를 left click하면 쉘의 paste highlight pending 상태를 해제해야 하며, 같은 click/drag의 tuimux selection 동작은 유지해야 한다.
...
- **4.4 / 2026-06-13**: paste 후 일반 terminal click이 쉘 paste highlight를 해제하는 요구사항과 regression test를 추가.
