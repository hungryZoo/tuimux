...
- **FR-REL-1 [P0]** v0.2.0-alpha.16 프리릴리즈는 macOS Apple Silicon tarball만 게시한다.
...
- **AC-26 [P0]** macOS PTY UI smoke는 실제 `tuimux` TUI에서 SGR mouse drag, Ctrl-C, `pbpaste`, foreground child SIGINT 미전달, host bracketed paste 전달을 검증해야 한다.
