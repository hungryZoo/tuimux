...
v0.2.0-alpha.15 keeps the default runtime on the Rust-native path and focuses
...
- Mouse selection is preserved after mouse-up and selected text is extracted by the daemon from the active PTY screen; macOS PTY smoke covers drag + Ctrl-C + `pbpaste`.
...
Pushing a tag like `v0.2.0-alpha.15` triggers `.github/workflows/release.yml`,
