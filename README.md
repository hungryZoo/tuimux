...
v0.2.0-alpha.14 keeps the default runtime on the Rust-native path and focuses
...
- Mouse selection is preserved after mouse-up and selected text is extracted by the daemon from the active PTY screen.
...
Pushing a tag like `v0.2.0-alpha.14` triggers `.github/workflows/release.yml`,
